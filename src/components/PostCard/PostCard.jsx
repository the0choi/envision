...
export default function PostCard(props) {
  ...
  return (
    <div className="rounded-xl group relative hover:border border-white hover:border-2 border-opacity-30 hover:cursor-pointer card overflow-hidden" onClick={showPost}>
      <img className="w-full h-auto object-cover rounded-xl transition ease-in-out hover:scale-110 hover:z-10 duration-300" src={props.post.photo} alt={props.post.prompt} draggable="false" />
