        ...
        <div className="flex flex-col">
          <div className="flex gap-5">
            <div className="flex flex-col">
              ...
              <textarea className="w-96 h-full py-4 px-4 my-1 rounded-xl bg-[#1c1c1c] text-white border border-white border-1 border-opacity-30" name="prompt" maxlength="400" placeholder="Start with a detailed description..." value={form.prompt} onChange={handleChange} />
